...
→ **PROJECT** lesson = recorded here ("Project deviations") / in the relevant spec · **PLAYBOOK** lesson = an entry in `PLAYBOOK-FEEDBACK.md` (handed back to the canonical repo at project end).
